...
urlpatterns = [
    ...
    re_path(r'^(?P<room_id>\d+)/user/(?P<member_id>\d+)/tickets$', views.menu_user_tickets, name="user_tickets"),
    re_path(r'^(?P<room_id>\d+)/user/(?P<member_id>\d+)/refund_ticket/(?P<ticket_purchase_id>\d+)/$', views.refund_ticket, name="refund_ticket"),
