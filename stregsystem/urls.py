...
urlpatterns = [
    ...
    re_path(r'^(?P<room_id>\w+)/$', views.index, name="menu_index"),
    re_path(r'^(?P<room_id>\w+)/sale/$', views.sale, name="quickbuy"),
    re_path(r'^(?P<room_id>\w+)/sale/(?P<member_id>\d+)/$', views.menu_sale, name="menu"),
    re_path(r'^(?P<room_id>\w+)/sale/\d+/\d+/$', lambda request, room_id: redirect('menu_index', room_id=room_id),
            name="menu_sale"),
    re_path(r'^(?P<room_id>\w+)/user/(?P<member_id>\d+)/$', views.menu_userinfo, name="userinfo"),
    re_path(r'^(?P<room_id>\w+)/user/(?P<member_id>\d+)/pay$', views.menu_userpay, name="userpay"),
    re_path(r'^(?P<room_id>\w+)/user/(?P<member_id>\d+)/rank$', views.menu_userrank, name="userrank"),
